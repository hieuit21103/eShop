...
//             case "success":
//                 return <p>Your email has been successfully confirmed!</p>;
//             case "error":
//                 return <p>There was an error confirming your email. Please try again.</p>;
//             case "invalid":
//                 return <p>Invalid confirmation token.</p>;
//             default:
